        ...
        >
          <div className="bg-white flex flex-col gap-y-3 justify-center items-center text-large-regular p-4 h-full w-full border-t border-gray-200">
            ...
            <div className="grid grid-cols-2 w-full gap-x-4">
              <Button onClick={open} variant="secondary" className="rounded-lg">
              ...
              <Button onClick={addToCart} className="rounded-lg" style={{ background: "#3D8B7A", borderColor: '#3D8B7A', color: 'white' }}>
