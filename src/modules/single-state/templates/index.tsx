...
import StateHero from "@modules/home/components/state-hero"
...
import FeaturedMarkets from "@modules/home/components/featured-markets"

const SingleStateTemplate = (props) => {
  const [params, setParams] = useState<StoreGetProductsParams>({})
  const { store, users, state } = props
  ...
  return (
    <>
      ...
      <div className="flex flex-col px-1 py-4 relative top-[-100px] sm:top-[-105px] md:top-[-110px] lg:top-[-115px] xl:top-[-120px]">
        <FeaturedMarkets
          title={`Popular Markets in ${state?.stateName}`}
          state={state}
        />
      </div>
      {/* 
...
export default SingleStateTemplate
