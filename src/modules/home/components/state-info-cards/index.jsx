...
const StateInfoCards = (props) => {
  ...
  const metrics = {
    ...
    fields: [
      {
        id: "Registered Markets",
        name: "Registered Markets",
        icon: BiPackage,
        value: store?.markets.length,
      },
      {
        id: "Nearby Mini Markets",
        name: "Nearby Mini Markets",
        icon: BiCategory,
        value: store?.un_reg_markets.length,
      },
      {
      ...
      <div className="content-container py-2">
        <div className="flex w-full justify-start items-end">
          <div
            ...
            overflow-hidden rounded-xl dark:bg-gray-600 m-1 dark:ring-gray-500 p-1 shadow-card"
          ...
          >
            ...
            >
              ...
              >
                {store?.stateName.split("")[0]}
              </span>
            </div>
          </div>
          <div
            className="flex flex-col items-center text-center mb-3 md:mb-5 lg:mb-3 xl:mb-3"
            style={{ fontFamily: "Lemon, serif" }}
          >
        ...
        <ul
          className="grid grid-cols-1 small:grid-cols-4 gap-x-4 gap-y-2 mt-4"
        >
