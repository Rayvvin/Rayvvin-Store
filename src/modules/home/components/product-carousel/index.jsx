  ...
  return (
    <div className="py-6">
      <div className="content-container py-2">
        ...
        <div className="flex flex-row justify-center lg:justify-between xl:justify-between w-full min-w-80 max-w-full">
          {/* Fliter Type */}
          {filters
                  ...
                  <div key={i}>
                    ...
                    <div className="flex flex-row justify-center lg:justify-between xl:justify-between w-full min-w-80 max-w-full">
                      <div className="flex flex-col items-center lg:items-start mb-4">
                        ...
                        <p className="text-[23px] xs:text-[23px] sm:text-[22px] font-bold text-gray-900 max-w-lg mb-2 text-center lg:text-start lg:whitespace-nowrap">
                          {title ? title : filter.title}
                        </p>
                      </div>
                    </div>
        ...
        <div
          ...
          } gap-x-4 flex-auto justfiy-around flex-nowrap mb-4 min-w-80 overflow-x-auto max-w-full`}
